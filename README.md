...
$$Acc = 1 - MAPE$$ To identify the contribution of each additional data interval, the change in accuracy, $$Delta Acc(j)$$, between successive intervals is calculated as:
